...
object ShortcutUtils {
    ...
    private fun createInstagramLogoBitmap(): Bitmap {
        val size = 192
    ...
    fun createYouTubeShortcut(context: Context): Boolean {
        return try {
            val intent = Intent(context, MainActivity::class.java).apply {
                action = Intent.ACTION_VIEW
    ...
    private fun createYouTubeLogoBitmap(): Bitmap {
        val size = 192
        val bitmap = Bitmap.createBitmap(size, size, Bitmap.Config.ARGB_8888)
        val canvas = Canvas(bitmap)
    ...
    fun createSpotifyShortcut(context: Context): Boolean {
        return try {
            val intent = Intent(context, MainActivity::class.java).apply {
                action = Intent.ACTION_VIEW
    ...
    private fun createSpotifyLogoBitmap(): Bitmap {
        val size = 192
        val bitmap = Bitmap.createBitmap(size, size, Bitmap.Config.ARGB_8888)
        val canvas = Canvas(bitmap)
